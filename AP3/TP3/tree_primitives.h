...
/* Inserer val a la racine dans l'arbre; l'arbre doit rester ordonee; methode par decoupage */
void insert_2_root(tree_t* a, s_base_t val);
/* Inserer val a la racine dans l'arbre; l'arbre doit rester ordonee; methode par rotation */
